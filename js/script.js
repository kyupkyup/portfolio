...
function swapCards(direction) {
  ...
  const previousPreviousCardEl = cardsContainerEl.querySelector(
    ".previousprevious--card"
  );
  ...
  function swapCardsClass() {
    ...
    if (direction === "right") {
      ...
      previousPreviousCardEl.style.zIndex = "20";
      nextNextCardEl.style.zIndex = "5";
      nextBgImageEl.style.zIndex = "-1";
...
function changeInfo(direction) {
  ...
  let previousPreviousInfoEl = cardInfosContainerEl.querySelector(
    ".previousprevious--info"
  );
  ...
  function swapInfosClass() {
    ...
    nextNextInfoEl.classList.remove("nextnext--info");
